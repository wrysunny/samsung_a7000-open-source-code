...
public class RadioDNS {
     ...
     * 
     * @param country
     *            Global Country Code (GCC) or ISO 3166-1 alpha-2 country code
     * @param pi
     ...
     */
    public Service lookupFMService(String country, String pi, int frequency) throws LookupException {
     ...
     * @param sid
     *            Service Identifer (SId)
     * @param scids
     *            Service Component Identifer within the Service (SCIdS)
     * @param pa
     *            Packet Address (PA)
     * @return Service
     * @throws LookupException
     */
    public Service lookupDABService(String gcc, String eid, String sid, String scids, int pa)
            throws LookupException {
     ...
     *            Service Component Identifer within the Service (SCIdS)
     * @param xpad
     *            X-PAD Applicaton Type (AppTy) and User Applicaton type
     * @return Service
     * @throws LookupException
     */
    public Service lookupDABService(String gcc, String eid, String sid, String scids, String xpad)
            throws LookupException {
     ...
     * @throws LookupException
     */
    public Service lookupAMService(String type, String sid) throws LookupException {
     ...
     * 
     * @param authoritativeFqdn
     *            Authoritative FQDN String
     * @return Service
     * @throws LookupException
     */
    public Service lookupIPService(String authoritativeFqdn) throws LookupException {
