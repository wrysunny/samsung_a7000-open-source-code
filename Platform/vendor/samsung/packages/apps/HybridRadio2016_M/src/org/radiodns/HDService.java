...
public class HDService extends Service { /* * Transmitter identifier value */
    private String mTx; /* * Country code value */
    private String mCc;

    /**
     * * Class constructor * * @param cc Country code * @param tx Transmitter
     * identifier value * @throws LookupException
     */
